...
const AppealGrid: React.FC = () => {
  const [rows, setRows] = useState<GridRowsProp>(AppealData as GridRowsProp);
  const [nextId, setNextId] = useState<number>(AppealData.length + 1);
  ...
  // FIX: Use GridRowId[] instead of GridRowSelectionModel[]
